    ...
    <animated.div style={props} className="wings">
      ...
      <section className="wing-section">
        ...
        <div className="wing-details">
          ...
          <b>HEAD: Harshit Saroha</b><br></br>
          <b>HEAD: Aaditya Raj</b>
        </div>
      </section>
      <section className="wing-section">
        <div className="wing-header">Projects, Research and Development</div>
        <div className="wing-details">
          <ul>
          ...
          <b>HEAD: Shriyansh Agrawal</b><br></br>
          <b>Head: Ranjith D S</b>
        </div>
      </section>
      <section className="wing-section">
        ...
        <div className="wing-details">
          ...
          <b>HEAD: Sachin Gowda</b><br></br>
          <b>HEAD: Vijaylaxmi Patil</b>
        </div>
      </section>
      <section className="wing-section">
        ...
        <div className="wing-details">
          ...
          <b>HEAD: Aarushi Das</b><br></br>
          <b>HEAD: Dhruthi Rudrangi</b>
        </div>
      </section>
    </animated.div>
  );
